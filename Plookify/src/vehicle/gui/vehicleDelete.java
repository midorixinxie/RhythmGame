 ...
 * @author MichelleY
 */
public class vehicleDelete extends javax.swing.JFrame {

    /**
     * Creates new form vehicleDelete
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vehicleDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vehicleDelete().setVisible(true);
            }
        });
    }
