...
public class vehicleEdit extends javax.swing.JFrame {
               ...
               String listOfPartsUsed)
    {
                ...
                colour.setText(carColour);
                MoTRenewalDate.setText(MoTRenewal);
                lastServiceDate.setText(lastService);
                currentMileage.setText(mileage);
                warrantyCheck.setText(warrantyType);
                companyName.setText(compName);
                companyAddress.setText(compAddress);
                warrantyDateOfExpiry.setText(warrantyExpiry);
